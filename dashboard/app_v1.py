"""Local evidence dashboard: executed M4/M5/M9/M10 artifacts only."""
...
st.dataframe(basin_table(tuple(payload.basin_dispersion)), use_container_width=True, hide_index=True)
